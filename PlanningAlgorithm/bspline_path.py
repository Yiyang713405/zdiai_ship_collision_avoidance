...
def main():
    ...
    # way points
    # way_point_x = [0.0, 3.0, 4.0, 6.0, 10.0]
    # way_point_y = [0.0, 3.0, 5.0, 9.0, 10.0]
    way_point_x = [0.0, 3.0, 4.0, 6.0]
    way_point_y = [0.0, 3.0, 5.0, 9.0]
    n_course_point = 50  # sampling number

    plt.subplots()
    rax, ray, heading, curvature = approximate_b_spline_path(way_point_x, way_point_y, n_course_point, s=0.7)
